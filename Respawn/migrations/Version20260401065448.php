 ...
 */
final class Version20260401065448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Profils CHANGE avatar_url avatar_url VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Commentaires ADD CONSTRAINT fk_comm_profil FOREIGN KEY (id_Profil) REFERENCES Profils (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE Vote ADD CONSTRAINT fk_vote_profil FOREIGN KEY (id_Profil) REFERENCES Profils (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE Vote ADD CONSTRAINT fk_vote_post FOREIGN KEY (id_Post) REFERENCES Post (id_Post) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE Post ADD CONSTRAINT fk_post_profil FOREIGN KEY (id_Profil) REFERENCES Profils (id) ON DELETE CASCADE');
